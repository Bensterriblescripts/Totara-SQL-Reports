Select
CONCAT('<a target="_new" href = "https://crm.mito.org.nz/MITOCRM/main.aspx?etc=2&extraqs=formid%3d85b5f7f3-ac5a-4beb-95da-2fb3e6b50f38&id=%7b',u.idnumber,'%7d&pagetype=entityrecord">',u.username,'</a>') AS 'CRM link',
...
JOIN prefix_quiz_attempts attempts ON attempts.quiz = quiz.id and attempts.userid = u.id
...
AND cccc.rpl != 'Completed offline'
AND attempts.state != 'inprogress'
